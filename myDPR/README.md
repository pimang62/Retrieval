...
>> `kowiki-20240301-pages-articles.xml`

```
wikiextractor <xml_file_path> --no-templates
```
>> wikiextractor kowiki-20240301-pages-articles.xml --no-templates  # 3/8 python!=3.8.12 error
...
```
>>> python retriever.py -q "중국의 천안문 사태가 일어난 년도는?" -k 20 > retriever.log
```
...
>>> mkdir dataset & wget https://korquad.github.io/dataset/KorQuAD_v1.0_train.json -O datasets/KorQuAD_v1.0_train.json
>>> mkdir dataset & wget https://korquad.github.io/dataset/KorQuAD_v1.0_dev.json -O datasets/KorQuAD_v1.0_dev.json
- [Korean Wikipedia](https://dumps.wikimedia.org/kowiki/20220120/)
>> 수정: wget https://dumps.wikimedia.org/kowiki/20240301/kowiki-20240301-pages-articles.xml.bz2
>> 압축 풀기: bunzip2 kowiki-20240301-pages-articles.xml.bz2
>> [압축 Reference](https://ifuwanna.tistory.com/31)
