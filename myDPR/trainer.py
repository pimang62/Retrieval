...
if __name__ == "__main__":
    ...
    model.load(model_ckpt_path="model/kobert_biencoder.pt")  # "../model/kobert_biencoder.pt"
    train_dataset = Dataset(data_path="dataset/baemin.json",
                            passages_dir="baemin_passages_answer",
                            title_index_map_path="baemin_title_passage_map_answer.p",
                            passages_type="answer")
    valid_dataset = Dataset(data_path="dataset/baemin_valid.json",
                            passages_dir="baemin_passages_answer",
                            title_index_map_path="baemin_title_passage_map_answer.p",
                            passages_type="answer")
    my_trainer = Trainer(
        ...
        valid_every=30,
        best_val_ckpt_path="model/qa_model.pt",
    )
    my_trainer.fit()
